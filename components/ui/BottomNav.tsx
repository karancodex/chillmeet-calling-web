...
export default function BottomNav() {
    ...
    return (
        ...
        >
            <div className="bg-[#0B0F1A]/80 backdrop-blur-3xl border border-white/10 rounded-[2rem] shadow-[0_-20px_40px_-15px_rgba(0,0,0,0.5)] flex items-center justify-around p-2 pointer-events-auto max-w-sm mx-auto">
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            <item.icon className={clsx(
                                ...
                                isActive ? "text-luxury-gold scale-110" : "text-white/40 group-hover:text-white"
                            )} />
                            <span className={clsx(
                                "text-[8px] font-black uppercase tracking-widest transition-all duration-300",
                                isActive ? "text-luxury-gold" : "text-white/20 group-hover:text-white/60"
                            )}>
                                {item.name}
                            </span>
                            {isActive && (
                ...
                <Link
                    ...
                    className="flex items-center justify-center w-12 h-12 bg-luxury-gold rounded-full shadow-[0_0_20px_rgba(212,175,55,0.4)] active:scale-90 transition-transform -translate-y-2 border-4 border-[#020305]"
                >
