...
const steps = [
    {
        ...
        desc: "Tell us how you feel. We'll find the listener who perfectly resonates with your energy.",
    ...
    },
    {
        ...
        desc: "No registration required. Your identity remains 100% private and protected.",
        color: "text-blue-400",
        bg: "bg-blue-400/5"
    },
    {
        ...
        desc: "Talk to verified professionals who listen with empathy and deep understanding.",
    ...
    },
    {
        ...
        desc: "Release your stress and find clarity in just one session. Feel the difference immediately.",
