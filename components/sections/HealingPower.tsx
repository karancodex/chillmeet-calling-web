                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex items-center gap-4 justify-end lg:justify-start group">
                                <p className="text-slate-400 text-xs md:text-sm font-medium leading-relaxed max-w-[280px] order-1 lg:order-2">
                                    Private and anonymous voice support designed for absolute discretion.
                                </p>
                            ...
                            <div className="flex items-center gap-4 justify-end lg:justify-start group">
                                <p className="text-slate-400 text-xs md:text-sm font-medium leading-relaxed max-w-[280px] order-1 lg:order-2">
                                    Connect with empathetic professionals who are trained listeners.
                                </p>
                            ...
                            <div className="flex items-center gap-4 justify-end lg:justify-start group">
                                <p className="text-slate-400 text-xs md:text-sm font-medium leading-relaxed max-w-[280px] order-1 lg:order-2">
                                    Transform your mental clarity and reclaim your emotional freedom.
                                </p>
