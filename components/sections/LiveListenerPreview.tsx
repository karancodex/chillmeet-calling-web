        ...
        <section className="py-32 relative overflow-hidden bg-dark">
            ...
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-6xl font-black mb-6 text-white tracking-[-0.04em] leading-tight font-display">
                        Our Soulful <br />
                ...
                <div className="flex flex-wrap justify-center gap-8">
                    {listeners.map((listener, idx) => (
                        <motion.div
                            ...
                            className="bg-slate-900/40 backdrop-blur-3xl p-8 flex flex-col items-center text-center group border border-white/5 rounded-[3rem] hover:border-white/20 transition-all duration-700 w-full max-w-[280px] relative overflow-hidden shadow-2xl"
                        >
                            ...
                            <div className="relative mb-10">
                                ...
                                <div className="w-28 h-28 organic-shape-1 bg-linear-to-br from-slate-800 to-slate-900 flex items-center justify-center border border-white/10 relative overflow-hidden group-hover:rotate-12 transition-all duration-700 shadow-xl">
                                    <User className="w-10 h-10 text-white/20" />
                                </div>
                                <div className={`absolute bottom-2 right-2 w-5 h-5 rounded-full border-4 border-background ${listener.status === 'Available now' ? 'bg-green-500' : 'bg-amber-500'} shadow-lg`} />
                            </div>
