...
const content = (
    <>
        ...
        <p>The information and content provided on Sukun, including our website and services, are for informational and emotional support purposes only.</p>

        <h2>Not a Substitute for Professional Advice</h2>
        <p>We are not a provider of medical, psychological, or psychiatric services. Never disregard professional medical advice or delay in seeking it because of something you have read or heard on Sukun.</p>
        ...
        <p className="mt-4 italic">Sukun is not a crisis intervention service.</p>
    </>
);
