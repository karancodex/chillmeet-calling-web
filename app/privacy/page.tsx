...
const content = (
    <>
        ...
        <h2>Introduction</h2>
        <p>Sukun takes your privacy seriously. We operate on a principle of anonymity and emotional safety.</p>
        ...
        <h2>Call Privacy</h2>
        <p>Calls are audio-only and are not recorded by Sukun unless explicitly stated for quality assurance in specific training modules (with prior consent). We do not listen to your live calls.</p>
